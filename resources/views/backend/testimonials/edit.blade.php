          ...
          @endif --}}
        	...
        	<form action="{{ url('admin/testimonials') }}/{{ $objTestimonial->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"  placeholder="Enter name" value="{{ $objTestimonial->name }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('position') is-invalid @enderror" id="position" name="position"  placeholder="Enter position" value="{{ $objTestimonial->position }}">
