        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link {{ (Request::segment(1)=='admin' && (Request::segment(2)=='speakers' || Request::segment(2)=='eventsspeakers')) ? 'active' : ''  }} " href="{{ url('admin/speakers') }}">
                  <span data-feather="airplay"></span>
                  Speakers
                </a>
              </li> 
              ...
              <li class="nav-item">
                <a class="nav-link {{ (Request::segment(1)=='admin' &&(Request::segment(2)=='categories'|| Request::segment(2)=='subcategories')  ) ? 'active' : ''}} " href="{{ url('admin/categories') }}">
                  <span data-feather="shopping-cart"></span>
                  Categories
                </a>
              </li>     
