          ...
          <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="icon-box iconbox-theme-colored bg-white p-15 mb-30 border-1px">
              <a class="icon icon-dark border-left-theme-color-2-3px pull-left flip mb-0 mr-0 mt-5" href="#">
                <i class="{{ $objFeatures->icon }}"></i>
              </a>
              <div class="icon-box-details">
                <h4 class="icon-box-title font-16 font-weight-600 m-0 mb-5">{{ $objFeatures->title }}</h4>
                <p class="text-gray font-13 mb-0">{{ $objFeatures->description }}</p>
              </div>
            </div>    
          </div>
          @endforeach
            ...
            <div class="col-md-6">
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                <a href="#" class="post-thumb mr-10">
                    ...
                    <img style="height: 160px;width: 50px; "class="img-fullwidth" alt="" src="{{ $objEvent->Photo->photo }}">
                    @else
                ...
                <div class="post-right">
                  <h4 class="mt-0 mb-5"><a href="{{ url('event_details') }}/{{ $objEvent->id }}">{{ $objEvent->topics }}</a></h4>
                  ...
                  <a class="text-theme-colored font-13" href="{{ url('event_details') }}/{{ $objEvent->id }}">Read More →</a>
                </div>
              </article>
              @endforeach
            </div>
